...
financial figure in ₹ Cr and the single root cause.
...
- financial_impact: quantify exposure across 30/60/90 days in ₹ Cr.
- recommended_actions: 3-5 concrete actions. EACH must have a named role owner (e.g. "Zonal HR \
Head", "Chief Credit Officer", "Head of Customer Experience"), a 30/60/90-day timeline, an \
expected_outcome, and a priority.
